...
const scenes = [
  {
    ...
    cta: 'View Collection',
    leftImage: '/images/liar-2_transparent.png',
    leftAlt: 'F*cking Liar tee — solo',
    productImage: '/images/rebel-1_transparent.png',
  ...
  },
  {
    ...
    cta: 'Shop Now',
    leftImage: '/images/wavy-1_transparent.png',
    leftAlt: 'Wavy Core tee — group',
    productImage: '/images/wavy-2_transparent.png',
    productAlt: 'Wavy Core duo',
    panelBg: PANEL,
    textHead: '#141210',
    textBody: '#6A6460',
    scriptColor: '#C8371A',
  ...
  },
  {
    ...
    cta: 'Our Story',
    leftImage: '/images/pulpy-2_transparent.png',
    leftAlt: 'Pulpy tee — group',
    productImage: '/images/rebel-2_transparent.png',
